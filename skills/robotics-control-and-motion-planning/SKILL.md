---
name: robotics-control-and-motion-planning
description: Design control and motion planning stacks for stable goal-directed robot behavior. Use when tuning controllers and planning under constraints.
---
...
- Constraint and safety envelope handling
